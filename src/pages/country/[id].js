                    ...
                    <div className={styles.overview_panel}>
                        ...
                        <div className={styles.overview_numbers}>
                            <div className={styles.overview_population}>
                                ...
                                <div className={styles.overview_label}>Population</div></div>
                            <div className={styles.overview_area}>
                                <div className={styles.overview_value}>{country.area}</div>
                                <div className={styles.overview_label}>Area</div></div>
                        </div>
                    </div>
                </div>
                <div className={styles.container_right}>
                    <div className={styles.detail_panel}>
                        ...
                        <div className={styles.detail_panel_row}>
                            ...
                            <div className={styles.detail_panel_value}>{country.languages.map(({ name }) => name).join(", ")}</div>
                        </div>
                        <div className={styles.detail_panel_row}>
                            <div className={styles.detail_panel_label}>Currencies</div>
                            <div className={styles.detail_panel_value}>{country.currencies.map(({ name }) => name).join(", ")}</div>
                        </div>
                        <div className={styles.detail_panel_row}>
                        ...
                        <div className={styles.detail_panel_row}>
                            <div className={styles.detail_panel_label}>Gini index</div>
                            <div className={styles.detail_panel_value}>{country.gini}</div>
                        </div>
                        <div className={styles.detail_panel_borders}>
                            <div className={styles.detail_panel_borders_label}>Bordering countries</div>
                            <div className={styles.detail_panel_borders_container}>
                                {border.map(({ flag, name }) => (<div className={styles.detail_panel_borders_country}><img src={flag} alt={name} /><div className={styles.detail_panel_borders_name}>{name}</div></div>))}
                            </div>
                        </div>
                    </div>
                </div>
